#!/bin/sh
##############################################################################
# Stress-Test llama-server — Qwen3-4B on single P40 (pinned via compose)
# Model: Qwen3-4B-Q4_K_M (2.4 GB)
# Purpose: High-concurrency prefill to maximize GPU power draw
##############################################################################
...
echo "[startup] ======================================================="
echo "[startup] STRESS llama-server — Qwen3-4B (high concurrency)"
echo "[startup] ======================================================="
