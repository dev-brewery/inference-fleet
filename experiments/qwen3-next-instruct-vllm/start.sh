#!/bin/sh
##############################################################################
# Docker Startup Script for Qwen3-Next-Instruct on 2x Tesla P40
# Conversation Specialist & Research Agent - True Instruct Model (No Thinking Blocks)
##############################################################################

MODEL="/models/Qwen3-Next-80B-A3B-Instruct-Q3_K_M.gguf"
...
echo "[startup] Model Type: Instruct (Direct responses, no thinking blocks)"
...
echo "[startup] Starting llama-server with Qwen3-Next-Instruct..."
echo "[startup] Optimized for: Prose generation, conversation, research, tool use"
