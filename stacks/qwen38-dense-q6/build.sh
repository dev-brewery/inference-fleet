#!/bin/bash
##############################################################################
# Build script for Qwen3.8-27B Dense Docker image
#
...
# Backend clone: qwen38-dense-q6/llama.cpp @ b94041a98 (2026-08-16,
#   build 10452, >= b10419 required by the Qwen3.8 quants).
##############################################################################
...
IMAGE_NAME="qwen38-dense-server-local"
IMAGE_TAG="latest"

echo "=========================================="
echo "Building Qwen3.8-27B Dense Docker Image"
echo "=========================================="
echo ""
echo "Backend: upstream ggml-org/llama.cpp (own clone in this stack dir)"
