#!/bin/bash
##############################################################################
# Build script for Qwen3.6-35B-A3B Docker image
#
...
IMAGE_NAME="qwen36-server-local"
IMAGE_TAG="latest"

echo "=========================================="
echo "Building Qwen3.6-35B-A3B Docker Image"
echo "=========================================="
echo ""
...
# Step 1: Verify llama.cpp source exists
...
# Step 2: Verify llama-server is compiled
